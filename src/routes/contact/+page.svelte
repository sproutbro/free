...
<SectionWrapper>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="space-x-6 flex">
                    ...
                    <div class:active={data.currentPage === page}>
                        <a href={`?page=${page}&search=${data.search}`} class:active={data.currentPage === page}>{page}</a>
                    </div>
                    {/each}
                </div>
                </div>
    ...
    <div class="mt-6 flex justify-between">
        ...
        <div>
            <form>
                <input name="search" type="text" class="border-gray-300 border-2 rounded-md px-4 py-2" placeholder="검색어를 입력하세요">
